...
impl RMesure 
{
	...
	fn Fx(input_loc: f64, inv: bool) -> f64 
	{
		...
		let fx:[[f64;25];2] = [[99.999, 99.998, 99.99,  99.98,   99.9,   99.8,   99.0,  98.0,  96.0, 95.45, 95.0,  94.0,  92.0,  90.0,  88.0,  86.0,  84.0,  82.0,  80.0, 68.27,   60.0,   50.0, 38.29,   30.0, 0.0], //p
							   [4.4172, 4.2649, 3.8906, 3.719, 3.2905, 3.0902, 2.5758, 2.326, 2.054,  2.00, 1.96, 1.881, 1.751, 1.645, 1.555, 1.476, 1.405, 1.341, 1.282,  1.00, 0.8416, 0.6745,  0.50, 0.3853, 0.0]]; //k
